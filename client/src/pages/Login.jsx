...
const Login = () => {
  return (
    <div className="min-h-screen flex flex-col md:flex-row">
      ...
      />
      {/* branding */}
      <div className="flex-1 flex flex-col items-start justify-between p-6 md:p-10 lg:pl-30">
        <img src={assets.logo} alt="" className="h-35 object-contain" />
        <div>
          ...
          <p className="text-xl md:text-3xl text-indigo-900 max-w-72 md:max-w-md">
            Connect With Peeps Across the Globe With Assurance
          </p>
        </div>
